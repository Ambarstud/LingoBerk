  ...
  return (
    <div className="px-4 pt-6 pb-4">
      <div className="flex items-center gap-3 mb-8">
        ...
        <h1 className="text-xl font-bold text-[#1A1A1A] dark:text-[#F5F5F5]">AI Chat</h1>
      </div>

      <div className="flex flex-col items-center justify-center pt-12">
        <div className="p-6 bg-orange-100 dark:bg-orange-900/30 rounded-2xl mb-6">
          <MessageCircle size={48} className="text-orange-600 dark:text-orange-400" />
        </div>
        ...
        <p className="text-gray-500 dark:text-gray-400 text-center mb-8 max-w-xs">
          Free-form English conversation with real-time grammar correction using Claude, GPT, or Gemini. Coming in Phase 2.
        </p>
        ...
        <Card className="w-full">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">Grammar corrections, topic chips, multi-provider</p>
            </div>
          </div>
        </Card>

        <div className="mt-6 w-full space-y-3">
          {['Free Conversation', 'Travel Scenarios', 'Work Topics', 'Maritime English', 'YDS Prep'].map((topic) => (
